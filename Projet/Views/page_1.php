...
<html lang="fr" dir="ltr">
  ...
  <body>
    ...
    <form action="../Modele/inter.php" method="post">
    <div class="">
    <div class="">
      <div class="">  <p>Titre : </p>  <input type="text" name="titre" required>          </div>
    </div>
    <div class="">
      <div class="">  <p>Categorie : </p>  <input type="text" name="categorie"  required>          </div>
    </div>
    <div class="">
      <div class="">  <p>Contenu : </p> <textarea name="contenu" rows="12" cols="60" required></textarea>        </div>
    </div>
    <div class="">
